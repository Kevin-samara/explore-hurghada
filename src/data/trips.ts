...
export const trips: Trip[] = [
  ...
  // ─────────────────────────────────────────
  {
    ...
    titleAr: 'نقل المطار',
    description:
      'Comfortable and reliable transportation between Hurghada Airport and your hotel. Our professional drivers ensure a smooth, punctual, and stress-free arrival or departure experience.',
    descriptionAr:
    ...
    excluded: ['Gratuities (optional)', 'Parking fees if any'],
    excludedAr: ['الإكرامية (اختيارية)', 'رسوم الانتظار إن وجدت'],
    itinerary: [
      { time: 'On arrival', title: 'Airport Pickup', titleAr: 'الاستقبال في المطار', description: 'Your driver will meet you at the arrivals hall with a name board.', descriptionAr: 'سيستقبلك السائق في صالة الوصول بلوحة تحمل اسمك.' },
      { time: 'Immediate', title: 'Luggage Assistance', titleAr: 'مساعدة في الأمتعة', description: 'Help with your bags to the vehicle.', descriptionAr: 'مساعدة في حمل الحقائب إلى المركبة.' },
      { time: '~30 min', title: 'Comfortable Transfer', titleAr: 'انتقال مريح', description: 'Air-conditioned transfer to your hotel.', descriptionAr: 'انتقال مكيف إلى فندقك.' },
    ],
    availableTimes: ['Anytime — 24/7'],
    featured: false,
    badge: '24/7',
    badgeAr: '٢٤/٧',
  },
